...
#define Globals_h
	...
	#define BLACK_KING_CASTLE_LEFT 114
	#define BLACK_ROOK_CASTLE_LEFT 115
	#define BLACK_KING_CASTLE_RIGHT 118
	#define BLACK_ROOK_CASTLE_RIGHT 117
	#define WHITE_ROOK_LEFT ROWS(7)
	#define WHITE_ROOK_RIGHT ROWS(7) + 7
	#define WHITE_KING_POS 116
	#define WHITE_KING_CASTLE_LEFT 2
	#define WHITE_ROOK_CASTLE_LEFT 3
	#define WHITE_KING_CASTLE_RIGHT 6
	#define WHITE_ROOK_CASTLE_RIGHT 5
