...
#define Globals_h
	...
	#define STALEMATE 0
	#define BLACK_CANT_CASTLE_RIGHT 0b0111
	#define BLACK_CANT_CASTLE_LEFT 0b1011
	#define WHITE_CANT_CASTLE_LEFT 0b1101
	#define WHITE_CANT_CASTLE_RIGHT 0b1110
	#define BLACK_CAN_CASTLE_RIGHT 0b1000
	#define BLACK_CAN_CASTLE_LEFT 0b0100
	#define WHITE_CAN_CASTLE_LEFT 0b0010
	#define WHITE_CAN_CASTLE_RIGHT 0b0001
