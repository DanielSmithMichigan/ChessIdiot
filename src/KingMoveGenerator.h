...
#define KingMoveGenerator_h
	...
	class KingMoveGenerator : public MoveGenerator{
		private:
			...
			int whiteCastleSquaresEast[3] = {117, 118, SOMEWHERE_OFF_BOARD};
			int whiteCastleSquaresWest[3] = {115, 114, 113};
			int blackCastleSquaresEast[3] = {4, 4, SOMEWHERE_OFF_BOARD};
			int blackCastleSquaresWest[3] = {1, 2, 3};
		...
		public:
			...
			int (&getArrayOfSquares(int from, int eastWest))[3];
	};
#endif